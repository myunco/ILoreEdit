...
ILoreEdit is a Minecraft server plugin that offers features such as editing item display name and lore, changing skull owner, and setting custom model data.

For a detailed description of the plugin, please visit ~~[mcbbs.net](https://www.mcbbs.net/thread-1160634-1-1.html)~~ [myunco.net](https://myunco.net/thread-3-1-1.html).

bStats
---
[![bStats Graph Data](https://bstats.org/signatures/bukkit/ILoreEdit.svg)](https://bstats.org/plugin/bukkit/ILoreEdit)

Releases
---
You can find official releases in the following places:
- ~~**MCBBS**: https://www.mcbbs.net/thread-1160634-1-1.html~~
- **MyForum**: https://myunco.net/thread-3-1-1.html
- **BaiduNetdisk**: https://pan.baidu.com/s/1-u-4P_pfLaehI5CowmabUQ?pwd=fhdg
- **Github**: https://github.com/myunco/ILoreEdit/releases

How to install? / Installation / Setup
---
* Download the latest version plugin.
* Place the ILoreEdit-1.x.x.jar file in the plugins folder.
